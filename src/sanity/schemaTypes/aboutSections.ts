...
// 1. Hero
export const aboutSection1 = defineType({
    name: 'aboutSection1',
    title: '01. Hero',
    type: 'document',
    fields: [
...
// 2. Our Story
export const aboutSection2 = defineType({
    name: 'aboutSection2',
    title: '02. Our Story',
    type: 'document',
    fields: [
...
// 3. Vision
export const aboutSection3 = defineType({
    name: 'aboutSection3',
    title: '03. Vision',
    type: 'document',
    fields: [
...
// 4. Mission
export const aboutSection4 = defineType({
    name: 'aboutSection4',
    title: '04. Mission',
    type: 'document',
    fields: [
...
export const aboutSection5 = defineType({
    name: 'aboutSection5',
    title: '05. Leadership Collective',
    type: 'document',
    fields: [
        defineField({
            name: 'leadership',
...
// 6. Evolution Journey
export const aboutSection6 = defineType({
    name: 'aboutSection6',
    title: '06. Evolution Journey',
    type: 'document',
    fields: [
        defineField({
...
// 7. Cultural Fabric
export const aboutSection7 = defineType({
    name: 'aboutSection7',
    title: '07. Cultural Fabric',
    type: 'document',
    fields: [
...
// 8. Core Values
export const aboutSection8 = defineType({
    name: 'aboutSection8',
    title: '08. Core Values',
    type: 'document',
    fields: [
...
// 9. How We Work
export const aboutSection9 = defineType({
    name: 'aboutSection9',
    title: '09. How We Work',
    type: 'document',
    fields: [
...
export const aboutSection10 = defineType({
    name: 'aboutSection10',
