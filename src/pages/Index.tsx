...
const Index = () => {
    ...
    useEffect(() => {
      ...
      "deploymentMilestones": *[_type == "homeSection11"][0],
      ...
      "industries": *[_type == "homeSection18"][0],
      "innovation": *[_type == "homeSection19"][0],
      "productFocus": *[_type == "homeSection20"][0],
      "crmCases": *[_type == "homeSection21"][0],
      "intelligentAuto": *[_type == "homeSection22"][0],
      "whyChooseCases": *[_type == "homeSection23"][0],
      ...
      "founders": *[_type == "homeSection37"][0],
