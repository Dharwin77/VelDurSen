...
const faqs = [
  { question: "How do I apply for a job at Veldursen?", answer: "Visit our Careers page, browse open roles, and click 'Apply Now' on the position that fits your skills. You can also use the Quick Apply feature to submit your resume directly." },
  { question: "Does Veldursen offer remote jobs?", answer: "Yes, we are a remote-first company with team members globally. Many roles are fully remote, while some may be hybrid depending on the team requirements." },
  { question: "What is the hiring process timeline?", answer: "Typically, the process takes 2-4 weeks from application to offer. We value your time and aim to move as efficiently as possible while ensuring a good fit." },
  { question: "What tools does the team use?", answer: "Our engineering teams use React, Node.js, and cloud infrastructure. Design teams rely on Figma and Miro. We use Slack and Zoom for daily collaboration." },
];
...
const Careers = () => {
  ...
  return (
    <HelmetProvider>
      <PageLayout>
        <Helmet>
          <title>Careers at Veldursen | Software Development Jobs</title>
          <meta name="description" content="Explore software development careers at Veldursen. We hire frontend developers, backend engineers, UI/UX designers, and QA professionals for remote and hybrid roles." />
          ...
          <script type="application/ld+json">
            {JSON.stringify({
              ...
              "sameAs": ["https://twitter.com/veldursen", "https://linkedin.com/company/veldursen"]
            })}
          </script>
        </Helmet>

        {/* Floating Quick Apply and Modals */}
        <AnimatePresence>
          {!showQuickApply && (
            <motion.button
              initial={{ scale: 0 }}
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              ...
              <div className="text-xl text-slate-700 space-y-8 leading-relaxed">
                ...
                <p>
                  We operate with clarity and ownership. Every team member understands how their work contributes to the larger outcome.
                </p>
                <p>
                  We prioritize steady growth, respectful collaboration, and meaningful technical discussions. The goal is not just to ship features, but to build solutions that last.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute top-8 left-0 h-1 bg-slate-300 md:block hidden"
                style={{ zIndex: 0 }}
              />
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10 pt-16 md:pt-0">
                {[
                  { year: "2019", title: "Company Founded" },
                  { year: "2020", title: "First Enterprise Client" },
                  { year: "2022", title: "Global Project Expansion" },
                  { year: "2024", title: "50+ Product Deliveries" }
                ].map((milestone, i) => (
                  <motion.div
                    key={i}
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      className="w-4 h-4 bg-[#C0392B] rounded-full absolute -top-[38px] left-1/2 -translate-x-1/2 hidden md:block border-2 border-white shadow-md z-20"
                    />

                    <div className="bg-white p-6 rounded-xl shadow-lg border border-slate-100 hover:shadow-xl transition-shadow duration-300">
                      <div className="text-3xl font-bold text-[#C0392B] mb-2">{milestone.year}</div>
                      <div className="text-slate-700 font-medium">{milestone.title}</div>
                    </div>
                  </motion.div>
                ))}
              </div>
          ...
          <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 mb-12 max-w-3xl mx-auto">
                Whether you are beginning your career or bringing professional experience, we offer structured growth paths and clear expectations.
              </p>
            </div>
        ...
        <section className="py-24 bg-slate-50">
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <h2 className="text-4xl font-bold mb-4">Growth & Learning</h2>
              <p className="text-xl text-slate-600">Invest in your future with us.</p>
            </motion.div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { title: "Technical Growth", desc: "Master new languages and frameworks with dedicated learning time and resources." },
                { title: "Leadership Opportunities", desc: "Step into mentorship roles and lead projects from conception to delivery." },
                { title: "Cross-Team Exposure", desc: "Collaborate with design, product, and engineering teams to broaden your perspective." },
                { title: "Learning Support", desc: "Access annual budgets for certifications, courses, and technical conferences." }
              ].map((card, i) => (
                <motion.div
                  key={i}
                  ...
                  className="h-full"
                >
                  <SpotlightCard className="p-8 h-full shadow-lg border border-slate-100 transition-all duration-300" spotlightColor="rgba(192, 57, 43, 0.15)">
                    <h3 className="text-xl font-bold mb-4 text-[#C0392B]">{card.title}</h3>
        ...
        <section className="py-24 bg-slate-900 text-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <motion.div
              ...
              className="text-center mb-16"
            >
              <h2 className="text-4xl font-bold mb-4 text-orange-500">Our Impact</h2>
              <p className="text-slate-300 max-w-2xl mx-auto text-lg">Delivering measurable results for clients globally.</p>
            </motion.div>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
              {[
                { label: "Projects Delivered", value: 50, suffix: "+" },
                { label: "Active Clients", value: 30, suffix: "+" },
                { label: "Years of Operations", value: 5, suffix: "+" },
                ...
                >
                  <div className="text-5xl md:text-6xl font-bold mb-2 text-orange-500 font-mono tracking-tight drop-shadow-md">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative group">
                <img src="/images/culture.png" alt="Veldursen Team Culture" className="w-full h-full object-cover rounded-2xl shadow-2xl transform group-hover:scale-105 transition-transform duration-500" loading="lazy" />
              </motion.div>
        ...
        {/* SECTION 3: A DAY AT VELDURSEN (Intro Text) */}
        <section className="py-16 bg-slate-50">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <h2 className="text-4xl font-bold mb-8">A Day at Veldursen</h2>
            <div className="space-y-6 text-lg text-slate-700 text-left">
              {[
                "Most days begin with a focused team sync to align priorities. After that, time is protected for deep work. Meetings are intentional and kept concise.",
                "Design reviews and engineering discussions are collaborative and direct. Feedback is open and respectful.",
                "Remote and hybrid team members are trusted to manage their schedules while maintaining accountability."
              ].map((text, i) => (
                <motion.p
                  key={i}
                  initial={{ opacity: 0 }}
        ...
        {/* Existing "Day in the Life" Interactive Section */}
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
              <p className="text-xl text-slate-600">Click to explore specific employee journeys</p>
            </motion.div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {employeeProfiles.map((emp, i) => (
                <motion.div key={i} whileHover={{ scale: 1.02 }} className="bg-slate-50 rounded-2xl p-8 cursor-pointer overflow-hidden text-center shadow-md hover:shadow-xl transition-all" onClick={() => setSelectedEmployee(i)}>
                  <div className="mb-6 flex justify-center">
                    <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-[#C0392B]/20 shadow-lg">
                      <img src={emp.image} alt={emp.name} className="w-full h-full object-cover" loading="lazy" />
                    </div>
                  </div>
                  <div>
        ...
        {/* Existing: Career Growth Simulator */}
        <section className="py-24 bg-slate-50 overflow-hidden">
          <div className="max-w-4xl mx-auto px-6">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
              <h2 className="text-4xl font-bold mb-4">Interactive Growth Path</h2>
              <p className="text-xl text-slate-600">Simulate your potential career trajectory</p>
            </motion.div>
            <div className="bg-white rounded-2xl p-8 shadow-xl">
              <label className="block mb-4 font-semibold" htmlFor="experience-slider">Experience Level: {experienceLevel} years</label>
              <input id="experience-slider" type="range" min="0" max="10" value={experienceLevel} onChange={(e) => setExperienceLevel(parseInt(e.target.value))} className="w-full mb-8" />
              <div className="grid grid-cols-3 gap-4 text-center">
                {[{ year: "Year 1", role: "Junior", salary: "$60-80K" }, { year: "Year 3", role: "Mid-Level", salary: "$90-120K" }, { year: "Year 5+", role: "Senior/Lead", salary: "$140-180K" }].map((stage, i) => (
                  <div key={i} className={`p-4 rounded-lgtransition-colors duration-300 ${experienceLevel >= i * 2 ? "bg-[#C0392B] text-white" : "bg-slate-100"}`}>
              ...
              <AnimatePresence mode="wait">
                {filteredJobs.map((job) => (
                  <motion.div
                    ...
                    className="h-full"
                  >
                    <HoverBorderGradientCard containerClassName="h-full" className="bg-slate-50 border-slate-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4 relative">
                ...
                {hiringSteps.map((step, i) => (
                  <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.15 }} className="relative text-center">
                    <NeonGradientCard className="h-[280px] flex flex-col justify-between p-6">
            ...
            <div className="space-y-4">
              {faqs.map((faq, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.1 }}
                  className="border border-slate-200 rounded-xl overflow-hidden bg-white hover:shadow-md transition-shadow duration-300"
                >
                  <button
                    onClick={() => setExpandedFaq(expandedFaq === i ? null : i)}
                    className="w-full p-6 text-left flex justify-between items-center outline-none focus:bg-slate-50"
                  ...
                  >
                    ...
                    >
                      <ChevronDown className="text-[#C0392B]" size={24} />
                    </motion.div>
                  </button>
        ...
        {/* Existing: Growth & Diversity (Keep) */}
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            {/* Growth section is replaced by the new Cards section essentially, but "Diversity" is unique. */}
            {/* I'll display Diversity here mostly. */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}><img src="/images/diversity.png" alt="Diversity at Veldursen" className="w-full rounded-2xl shadow-2xl" loading="lazy" /></motion.div>
