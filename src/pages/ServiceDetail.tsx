...
const ServiceDetail = () => {
    ...
    return (
        <HelmetProvider>
            <PageLayout>
                <Helmet>
                    <title>{service.title} | VelDurSen Services</title>
                    <meta name="description" content={service.description} />
                    <meta name="keywords" content={`${service.title}, ${service.tagline}, enterprise services, VelDurSen`} />
                </Helmet>
                        ...
                        <div className="enterprise-container relative z-10 px-4 md:px-6">
                            ...
                            >
                                ...
                                <div className="flex flex-wrap items-center gap-4 mt-12 pt-6 border-t border-white/5">
                                    <Link to="/contact" className="flex items-center gap-2.5 px-8 py-4 bg-[#dc2626] text-white rounded-full font-black text-[10px] uppercase tracking-widest hover:bg-[#b91c1c] transition-all hover:scale-105 shadow-xl shadow-red-600/20">
                        ...
                        <div className="enterprise-container relative z-10 px-4 md:px-6">
                            <div className="grid lg:grid-cols-12 gap-12">
                                ...
                                <div className="lg:col-span-12 xl:col-span-5">
                                    <div className="lg:bg-slate-50/80 p-8 rounded-[2rem] border border-slate-100 backdrop-blur-sm shadow-sm">
                                        ...
                                        <div className="mt-8 p-8 bg-slate-900 rounded-[2rem] text-white relative overflow-hidden shadow-2xl group/cta border border-slate-800">
                                            <div className="absolute top-0 right-0 w-32 h-32 bg-red-600 opacity-[0.05] rounded-bl-full group-hover/cta:scale-110 transition-transform duration-700 pointer-events-none" />
                                            <h3 className="text-xl font-black mb-3 relative z-30 leading-tight text-white drop-shadow-md">Build your next <br /> breakthrough.</h3>
                                            <p className="text-slate-400 text-xs mb-6 relative z-30 font-medium">Contact our solutions architects for a detailed consultation.</p>
                                            <Link to="/contact" className="block w-full text-center py-4 bg-[#dc2626] text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-[#b91c1c] transition-all relative z-30 shadow-lg shadow-red-600/20 hover:scale-[1.02]">
                                                Get Started Now
                                            </Link>
                                        </div>
                                    </div>
                            ...
                            {service.details && (
                                <div className="mt-20">
                                    <div className="inline-flex items-center gap-3 mb-10 justify-center w-full">
                                        <div className="w-12 h-1 bg-[#dc2626] rounded-full" />
                                        <h2 className="text-3xl md:text-4xl font-black text-[#0f172a] tracking-tight text-center">Comprehensive Capabilities</h2>
                                        <div className="w-12 h-1 bg-[#dc2626] rounded-full" />
                                    </div>

                                    <div className="grid md:grid-cols-2 gap-8">
                                        {service.details.map((category, idx) => (
                                            <motion.div
                                                key={idx}
                                                initial={{ opacity: 0, y: 20 }}
                                                ...
                                                className="bg-slate-50 border border-slate-100 p-8 rounded-[2rem] hover:bg-white hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-500"
                                            >
                                                <h3 className="text-xl font-black text-[#dc2626] mb-6 flex items-center gap-3">
                                                ...
                                                <div className="space-y-6">
                                                    {category.points.map((point, pIdx) => (
                                                        <div key={pIdx} className="group pl-4 border-l-2 border-slate-200 hover:border-[#dc2626] transition-colors duration-300">
                                                            <h4 className="font-bold text-[#0f172a] text-sm mb-1 group-hover:text-[#dc2626] transition-colors">{point.title}</h4>
