        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative group">
              <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1000&h=800&fit=crop" alt="Culture" className="w-full h-full object-cover rounded-2xl shadow-2xl transform group-hover:scale-105 transition-transform duration-500" />
            </motion.div>
              ...
              {filteredJobs.length > 0 ? filteredJobs.map((job) => (
                <motion.div key={job.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="bg-slate-50 border-2 border-slate-200 rounded-xl p-6 hover:border-[#C0392B] hover:shadow-xl transition-all">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <Link to="/contact" className="bg-[#C0392B] hover:bg-[#a02f24] text-white rounded-lg px-6 py-3 font-semibold inline-flex items-center gap-2 transition-all transform hover:scale-105 whitespace-nowrap">Apply Now <ArrowRight size={18} /></Link>
                  </div>
                </motion.div>
              )) : (
      ...
      <section className="py-24 bg-[#FBFBF9]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-[#5D4037] text-lg font-bold"><a href="mailto:careers@veldursen.com" className="hover:text-[#C0392B]">careers@veldursen.com</a></p>
          </motion.div>
        </div>
      </section>
    </PageLayout>
