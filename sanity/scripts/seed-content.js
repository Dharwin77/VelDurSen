...
const homePage = {
    ...
    sections: [
        ...
        {
            _type: 'deliveredOutcomes',
            _key: 'outcomes_sec',
            heading: 'Our Achievements',
            description: 'VelDurSen’s achievements represent a decade of relentless engineering innovation.',
            caseStudies: [
                { _key: 'cs1', title: 'Artificial Intelligence Innovation', description: 'Best Enterprise AI Innovation Award' },
                { _key: 'cs2', title: 'Multi-Cloud Infrastructure Excellence', description: 'Awarded for cloud resilience.' }
            ]
        }
    ]
}
