...
async function run() {
    ...
    console.log('Restoring homeSection13 with EXPLICIT caseStudy types...');
    await client.createOrReplace(data);

    // Cleanup any confusion
    await client.delete('drafts.homeSection13').catch(() => { });

    console.log('✅ Restoration complete. Everything is now properly integrated and editable.');
}
