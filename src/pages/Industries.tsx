...
const Industries = () => {
  return (
    <PageLayout>
      ...
      {/* 3.7 SMART CITIES — CONNECTED INFRASTRUCTURE */}
      <section className="py-8 bg-slate-50 relative overflow-hidden">
        <div className="enterprise-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">

            {/* Left side: Visual (Image Left) */}
            <motion.div
              initial={{ opacity: 0, x: -50 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
            ...
            >
              <div className="rounded-[2rem] overflow-hidden aspect-[4/3] shadow-2xl relative group">
                <img
                  src={industryImg2} // Placeholder
                  alt="Smart Cities"
                  className="w-full h-full object-cover transition-transform duration-[3s] group-hover:scale-105 filter saturate-0 group-hover:saturate-100"
                />
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="flex gap-2 mb-2">
                    ...
                    <div className="h-1 w-2 bg-slate-400/50 rounded-full" />
                    <div className="h-1 w-2 bg-slate-400/50 rounded-full" />
                  </div>
                  <h3 className="text-white text-xl font-bold leading-tight">Urban Intelligence Grid</h3>
                  <p className="text-slate-300 text-xs mt-1">Real-time infrastructure monitoring active.</p>
                </div>
              </div>
      ...
      {/* 3.8 FINTECH — SECURE DIGITAL LEDGER */}
      <section className="py-12 bg-white relative overflow-hidden">
        <div className="enterprise-container">
          <div className="flex flex-col lg:flex-row items-center gap-12">

            {/* Left side: Content (Text Left) */}
            <motion.div
              initial={{ opacity: 0, x: -50 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
            ...
            >
              <div className="relative z-10 rounded-[3rem] overflow-hidden shadow-2xl border-4 border-slate-50">
                <img
                  src={industryImg1} // Placeholder
                  alt="FinTech"
                ...
                <div className="absolute inset-0 flex items-center justify-center p-12">
                  <div className="w-full h-full border border-white/20 rounded-[2rem] bg-slate-900/40 backdrop-blur-sm p-8 flex flex-col justify-between relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-6 opacity-50"><Cpu className="text-white" size={40} /></div>

                    <div className="space-y-2 relative z-10">
                      <p className="text-slate-300 text-xs font-mono">HASH_TRANSACTION_ID: 8X92...F2</p>
                      <p className="text-white text-3xl font-bold">$842,000,000</p>
                      <div className="flex gap-1.5 mt-2">
                        {[1, 2, 3, 4, 5].map(k => <div key={k} className="h-1 w-full bg-emerald-500/50 rounded-full" />)}
                      </div>
                    </div>

                    <div className="space-y-4 relative z-10">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center"><ShieldCheck className="text-emerald-400" size={20} /></div>
                        <div>
                          <p className="text-[10px] text-slate-300 uppercase tracking-widest">Security Protocol</p>
                          <p className="text-white font-bold text-sm">Military-Grade Encryption</p>
                        </div>
                      </div>
                    </div>

                    {/* Scanning Line Animation */}
                    <div className="absolute top-0 left-0 w-full h-[2px] bg-red-500/50 shadow-[0_0_15px_rgba(239,68,68,0.8)] animate-[scan_4s_linear_infinite]" />
                  </div>
                </div>
              </div>
      ...
      {/* 3.9 GLOBAL DIGITAL INFRASTRUCTURE — CONNECTION LAYER */}
      <section className="py-8 bg-slate-50 relative overflow-hidden">
        <div className="enterprise-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="rounded-[2rem] overflow-hidden aspect-[16/9] shadow-2xl relative group border-4 border-white">
                ...
                <div className="absolute inset-0">
                  {[1, 2, 3].map((n) => (
                    <div key={n} className={`absolute w-2 h-2 bg-red-600 rounded-full animate-ping`} style={{ top: `${20 * n}%`, left: `${30 * n}%`, animationDuration: `${n + 1}s` }} />
                  ))}
                </div>
